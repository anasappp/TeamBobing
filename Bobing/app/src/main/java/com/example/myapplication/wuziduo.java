...
public class wuziduo extends AppCompatActivity {
    Intent a, b;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.wuziduo);
    ...
    class ButtonListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.fanhui:
                    a = new Intent(wuziduo.this, choooooose.class);
                    startActivity(a);
                    break;

                case R.id.restart:
                    b = new Intent(wuziduo.this, multi.class);
                    startActivity(b);
                    break;
            }
        }
