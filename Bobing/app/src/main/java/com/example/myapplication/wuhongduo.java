...
public class wuhongduo extends AppCompatActivity {
    Intent a, b;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.wuhongduo);
    ...
    class ButtonListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.fanhui:
                    a = new Intent(wuhongduo.this, choooooose.class);
                    startActivity(a);
                    break;

                case R.id.restart:
                    b = new Intent(wuhongduo.this, multi.class);
                    startActivity(b);
                    break;
            }
        }
