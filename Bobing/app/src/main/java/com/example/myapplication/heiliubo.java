...
public class heiliubo extends AppCompatActivity {
    Intent a, b;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.heiliubo);
    ...
    class ButtonListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.fanhui:
                    a = new Intent(heiliubo.this, choooooose.class);
                    startActivity(a);
                    break;

                case R.id.restart:
                    b = new Intent(heiliubo.this, singlegame.class);
                    startActivity(b);
                    break;
            }
        }
