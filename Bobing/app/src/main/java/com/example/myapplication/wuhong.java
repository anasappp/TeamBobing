...
public class wuhong extends AppCompatActivity {
    Intent a, b;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.wuhong);
    ...
    class ButtonListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.fanhui:
                    a = new Intent(wuhong.this, choooooose.class);
                    startActivity(a);
                    break;

                case R.id.restart:
                    b = new Intent(wuhong.this, singlegame.class);
                    startActivity(b);
                    break;
            }
        }
